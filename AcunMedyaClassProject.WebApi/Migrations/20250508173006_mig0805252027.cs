...
{
    /// <inheritdoc />
    public partial class mig0805252027 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LectureExams_AspNetUsers_StudentId",
                        column: x => x.StudentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_LectureExams_Lectures_LectureId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LectureExams_StudentId",
                table: "LectureExams",
                column: "StudentId");
